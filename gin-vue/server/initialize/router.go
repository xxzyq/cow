...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		inventoryRouter.InitInventoryDisplayRouter(PrivateGroup)
		inventoryRouter.InitMyApiRouter(PrivateGroup)
		inventoryRouter.InitTypeRouter(PrivateGroup)
		inventoryRouter.InitInInventoryRouter(PrivateGroup)
		inventoryRouter.InitOutInventoryRouter(PrivateGroup)
		inventoryRouter.InitCheckInventoryRouter(PrivateGroup)

	}
	{
		weightRecordRouter := router.RouterGroupApp.WeightRecord
		weightRecordRouter.InitWeightRecordRouter(PrivateGroup)
	}
