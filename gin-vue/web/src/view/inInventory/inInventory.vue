              ...
              switch (type.value) {
                case 'create':
                  ...
                  if (displayRes.code === 0) {
                      inventoryDisplay.value.number=formData.value.number + displayRes.data.reinventDis.number//更新后的数等于新的数加库存中原来的数
                      inventoryDisplay.value.totalValue=formData.value.number+displayRes.data.reinventDis.totalValue//总库存数等于原库存加上新增库存
