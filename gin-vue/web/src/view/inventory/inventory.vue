    ...
    <div>
      ...
      <div class="gva-table-box">
        ...
        >
          ...
          <el-table-column align="left" label="数量" prop="Accont" width="120" />
          <el-table-column align="left" label="单位" prop="Unit" width="120" />
          <el-table-column align="left" label="日期" prop="customerPhoneData" width="120" />
          <el-table-column align="left" label="时间" prop="sysUserId" width="120" />
          <el-table-column align="left" label="操作员" min-width="160">
            <template #default="scope">
